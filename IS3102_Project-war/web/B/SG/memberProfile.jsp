                                ...
                                <div id="loyaltyProgram" class="tab-pane">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <%
                                                int a = 100 / loyaltyTiers.size();
                                                int b = a;
                                                for (int i = 0; i < loyaltyTiers.size(); i++) {
                                                    if (a == (100 / loyaltyTiers.size())) {
                                                        b = 0;
                                                    } else {
                                                        b = a;
                                                    }
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="progress">
                                                        <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <%=b%>%; color:black; background-color: #cccccc;" >
                                                            <%=df.format(loyaltyTiers.get(i).getAmtOfSpendingRequired())%>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
